...
public class RutConsts
{
    ...
    public static final RektangelProp MENYLOAD = new RektangelProp(0.5,0.27,0.4,0.1);
    public static final RektangelProp MENYCREDITS = new RektangelProp(0.5,0.39,0.4,0.1);
    public static final RektangelProp MENYEXIT = new RektangelProp(0.5,0.51,0.4,0.1);
    public static final RektangelProp CREDITS = new RektangelProp(0.5,0.5,1.0,1.0);
