                             ...
                             Runnable
{
    ...
    public UI()
    {
        life = true;
        rutor = new Ruta[200];
        String[][] vissaRutor = {{"HPXPBAR/HPXPBARtom.png","HPXPBAR/HPBAR10.png","HPXPBAR/HPBAR25.png","HPXPBAR/HPBAR40.png","HPXPBAR/HPBAR55.png","HPXPBAR/HPBAR70.png","HPXPBAR/HPBAR85.png","HPXPBAR/HPBARfull.png"},
                                 {"HPXPBAR/HPXPBARtom.png","HPXPBAR/XPBAR10.png","HPXPBAR/XPBAR25.png","HPXPBAR/XPBAR40.png","HPXPBAR/XPBAR55.png","HPXPBAR/XPBAR70.png","HPXPBAR/XPBAR85.png","HPXPBAR/XPBARfull.png"}};
        rutor[0] = new Ruta(RutConsts.MENYSTART,true,true,"UI/MenyKnapp.png");
        rutor[1] = new Ruta(RutConsts.MENY2,true,true,"UI/MenyKnapp.png");
        rutor[2] = new Ruta(RutConsts.MENY3,true,true,"UI/MenyKnapp.png");
        rutor[3] = new Ruta(RutConsts.MENY4,true,true,"UI/MenyKnapp.png");
        rutor[4] = new Ruta(RutConsts.MENY5,true,true,"UI/MenyKnapp.png");
        rutor[5] = new Ruta(RutConsts.MENYEXIT,true,true,"UI/MenyKnapp.png");
        rutor[6] = new Ruta(RutConsts.BARHP,false,false,vissaRutor[0]);
        rutor[7] = new Ruta(RutConsts.BARXP,false,false,vissaRutor[1]);
        
        rutor[8] = new Ruta(RutConsts.INVENTORY,false,false,"UI/UIMenyKnapp.png");
		rutor[9] = new Ruta(RutConsts.SNP,false,false,"UI/UIMenyKnapp.png");
		rutor[10] = new Ruta(RutConsts.BOA,false,false,"UI/UIMenyKnapp.png");
		rutor[11] = new Ruta(RutConsts.QUESTLOG,false,false,"UI/UIMenyKnapp.png");
        rutor[12] = new Ruta(RutConsts.MENYBAREXIT,false,false,"UI/UIMenyKnapp.png");
        
        rutor[13] = new Ruta(RutConsts.INV1,false,false,"UI/InventoryRuta.png");
        rutor[14] = new Ruta(RutConsts.INV2,false,false,"UI/InventoryRuta.png");
        rutor[15] = new Ruta(RutConsts.INV3,false,false,"UI/InventoryRuta.png");
        rutor[16] = new Ruta(RutConsts.INV4,false,false,"UI/InventoryRuta.png");
		rutor[17] = new Ruta(RutConsts.INV5,false,false,"UI/InventoryRuta.png");
		rutor[18] = new Ruta(RutConsts.INV6,false,false,"UI/InventoryRuta.png");
		rutor[19] = new Ruta(RutConsts.INV7,false,false,"UI/InventoryRuta.png");
		rutor[20] = new Ruta(RutConsts.INV8,false,false,"UI/InventoryRuta.png");
		rutor[21] = new Ruta(RutConsts.INV9,false,false,"UI/InventoryRuta.png");
		rutor[22] = new Ruta(RutConsts.INV10,false,false,"UI/InventoryRuta.png");
		rutor[23] = new Ruta(RutConsts.INV11,false,false,"UI/InventoryRuta.png");
		rutor[24] = new Ruta(RutConsts.INV12,false,false,"UI/InventoryRuta.png");
		rutor[25] = new Ruta(RutConsts.INV13,false,false,"UI/InventoryRuta.png");
		rutor[26] = new Ruta(RutConsts.INV14,false,false,"UI/InventoryRuta.png");
		rutor[27] = new Ruta(RutConsts.INV15,false,false,"UI/InventoryRuta.png");
		rutor[28] = new Ruta(RutConsts.INV16,false,false,"UI/InventoryRuta.png");
		rutor[29] = new Ruta(RutConsts.INV17,false,false,"UI/InventoryRuta.png");
		rutor[30] = new Ruta(RutConsts.INV18,false,false,"UI/InventoryRuta.png");
		rutor[31] = new Ruta(RutConsts.INV19,false,false,"UI/InventoryRuta.png");
		rutor[32] = new Ruta(RutConsts.INV20,false,false,"UI/InventoryRuta.png");
		rutor[33] = new Ruta(RutConsts.INV21,false,false,"UI/InventoryRuta.png");
		rutor[34] = new Ruta(RutConsts.INV22,false,false,"UI/InventoryRuta.png");
		rutor[35] = new Ruta(RutConsts.INV23,false,false,"UI/InventoryRuta.png");
		rutor[36] = new Ruta(RutConsts.INV24,false,false,"UI/InventoryRuta.png");
		rutor[37] = new Ruta(RutConsts.INV25,false,false,"UI/InventoryRuta.png");
		rutor[38] = new Ruta(RutConsts.HEAD,false,false,"UI/HjälmHandskarSkor.png");
		rutor[39] = new Ruta(RutConsts.WEAPON,false,false,"UI/VapenSköldInventory.png");
		rutor[40] = new Ruta(RutConsts.ARMOR,false,false,"UI/ArmorInventory.png");
		rutor[41] = new Ruta(RutConsts.SHIELD,false,false,"UI/VapenSköldInventory.png");
		rutor[42] = new Ruta(RutConsts.GLOVES,false,false,"UI/HjälmHandskarSkor.png");
		rutor[43] = new Ruta(RutConsts.BOOTS,false,false,"UI/HjälmHandskarSkor.png");
	
		rutor[44] = new Ruta(RutConsts.AB1,false,false,"UI/UIMenyKnapp.png");
		rutor[45] = new Ruta(RutConsts.AB2,false,false,"UI/UIMenyKnapp.png");
		rutor[46] = new Ruta(RutConsts.AB3,false,false,"UI/UIMenyKnapp.png");
		rutor[47] = new Ruta(RutConsts.AB4,false,false,"UI/UIMenyKnapp.png");
		rutor[48] = new Ruta(RutConsts.AB5,false,false,"UI/UIMenyKnapp.png");
		rutor[49] = new Ruta(RutConsts.AB6,false,false,"UI/UIMenyKnapp.png");
		rutor[50] = new Ruta(RutConsts.AB7,false,false,"UI/UIMenyKnapp.png");
		rutor[51] = new Ruta(RutConsts.AB8,false,false,"UI/UIMenyKnapp.png");
		rutor[52] = new Ruta(RutConsts.AB9,false,false,"UI/UIMenyKnapp.png");
		rutor[53] = new Ruta(RutConsts.AB0,false,false,"UI/UIMenyKnapp.png");

		rutor[90] = new Ruta(RutConsts.SnPRubrik,false,false,"UI/SnPRubrik.png");
		
		rutor[91] = new Ruta(RutConsts.SnP1,false,false,"UI/SnPRuta.png");
		rutor[92] = new Ruta(RutConsts.SnP1,false,false,"UI/SnPRuta.png");
		rutor[93] = new Ruta(RutConsts.SnP1,false,false,"UI/SnPRuta.png");
		rutor[94] = new Ruta(RutConsts.SnP1,false,false,"UI/SnPRuta.png");
		rutor[95] = new Ruta(RutConsts.SnP1,false,false,"UI/SnPRuta.png");
		rutor[96] = new Ruta(RutConsts.SnP1,false,false,"UI/SnPRuta.png"); 
		
		rutor[54] = new Ruta(RutConsts.SnP1,false,false,"UI/SnPRuta.png");
		rutor[55] = new Ruta(RutConsts.SnP4,false,false,"UI/SnPRuta.png");
		rutor[56] = new Ruta(RutConsts.SnP8,false,false,"UI/SnPRuta.png");
		rutor[57] = new Ruta(RutConsts.SnP12,false,false,"UI/SnPRuta.png");
		rutor[58] = new Ruta(RutConsts.SnP16,false,false,"UI/SnPRuta.png");
		rutor[59] = new Ruta(RutConsts.SnP20,false,false,"UI/SnPRuta.png");
		
		rutor[60] = new Ruta(RutConsts.SnP1n1,false,false,"UI/UIMenyKnapp.png");
		rutor[61] = new Ruta(RutConsts.SnP1n2,false,false,"UI/SnPRuta.png");
		rutor[62] = new Ruta(RutConsts.SnP1n3,false,false,"UI/SnPRuta.png");
		rutor[63] = new Ruta(RutConsts.SnP1n4,false,false,"UI/SnPRuta.png");
		rutor[64] = new Ruta(RutConsts.SnP1n5,false,false,"UI/SnPRuta.png");
		
		rutor[65] = new Ruta(RutConsts.SnP4n1,false,false,"UI/SnPRuta.png");
		rutor[66] = new Ruta(RutConsts.SnP4n2,false,false,"UI/UIMenyKnapp.png");
		rutor[67] = new Ruta(RutConsts.SnP4n3,false,false,"UI/SnPRuta.png");
		rutor[68] = new Ruta(RutConsts.SnP4n4,false,false,"UI/SnPRuta.png");
		rutor[69] = new Ruta(RutConsts.SnP4n5,false,false,"UI/SnPRuta.png");
		
		rutor[70] = new Ruta(RutConsts.SnP8n1,false,false,"UI/SnPRuta.png");
		rutor[71] = new Ruta(RutConsts.SnP8n2,false,false,"UI/SnPRuta.png");
		rutor[72] = new Ruta(RutConsts.SnP8n3,false,false,"UI/UIMenyKnapp.png");
		rutor[73] = new Ruta(RutConsts.SnP8n4,false,false,"UI/SnPRuta.png");
		rutor[74] = new Ruta(RutConsts.SnP8n5,false,false,"UI/SnPRuta.png");
		
		rutor[75] = new Ruta(RutConsts.SnP12n1,false,false,"UI/SnPRuta.png");
		rutor[76] = new Ruta(RutConsts.SnP12n2,false,false,"UI/SnPRuta.png");
		rutor[77] = new Ruta(RutConsts.SnP12n3,false,false,"UI/SnPRuta.png");
		rutor[78] = new Ruta(RutConsts.SnP12n4,false,false,"UI/UIMenyKnapp.png");
		rutor[79] = new Ruta(RutConsts.SnP12n5,false,false,"UI/SnPRuta.png");
		
		rutor[80] = new Ruta(RutConsts.SnP16n1,false,false,"UI/SnPRuta.png");
		rutor[81] = new Ruta(RutConsts.SnP16n2,false,false,"UI/SnPRuta.png");
		rutor[82] = new Ruta(RutConsts.SnP16n3,false,false,"UI/SnPRuta.png");
		rutor[83] = new Ruta(RutConsts.SnP16n4,false,false,"UI/SnPRuta.png");
		rutor[84] = new Ruta(RutConsts.SnP16n5,false,false,"UI/UIMenyKnapp.png");
		
		rutor[85] = new Ruta(RutConsts.SnP20n1,false,false,"UI/UIMenyKnapp.png");
		rutor[86] = new Ruta(RutConsts.SnP20n2,false,false,"UI/UIMenyKnapp.png");
		rutor[87] = new Ruta(RutConsts.SnP20n3,false,false,"UI/SnPRuta.png");
		rutor[88] = new Ruta(RutConsts.SnP20n4,false,false,"UI/SnPRuta.png");
		rutor[89] = new Ruta(RutConsts.SnP20n5,false,false,"UI/SnPRuta.png");
		
		rutor[96] = new Ruta(RutConsts.l1,false,false,"UI/SnPPerkRuta.png");
		rutor[97] = new Ruta(RutConsts.l1p1,false,false,"UI/SnPPerkRuta.png");
		rutor[98] = new Ruta(RutConsts.l1p2,false,false,"UI/SnPPerkRuta.png");
		rutor[99] = new Ruta(RutConsts.l1p3,false,false,"UI/SnPPerkRuta.png");
		rutor[100] = new Ruta(RutConsts.l1p4,false,false,"UI/SnPPerkRuta.png");
		rutor[101] = new Ruta(RutConsts.l1p5,false,false,"UI/SnPPerkRuta.png");
		
		rutor[102] = new Ruta(RutConsts.l4,false,false,"UI/SnPPerkRuta.png");
		rutor[103] = new Ruta(RutConsts.l4p1,false,false,"UI/SnPPerkRuta.png");
		rutor[104] = new Ruta(RutConsts.l4p2,false,false,"UI/SnPPerkRuta.png");
		rutor[105] = new Ruta(RutConsts.l4p3,false,false,"UI/SnPPerkRuta.png");
		rutor[106] = new Ruta(RutConsts.l4p4,false,false,"UI/SnPPerkRuta.png");
		rutor[107] = new Ruta(RutConsts.l4p5,false,false,"UI/SnPPerkRuta.png");
		
		rutor[108] = new Ruta(RutConsts.l8,false,false,"UI/SnPPerkRuta.png");
		rutor[109] = new Ruta(RutConsts.l8p1,false,false,"UI/SnPPerkRuta.png");
		rutor[110] = new Ruta(RutConsts.l8p2,false,false,"UI/SnPPerkRuta.png");
		rutor[111] = new Ruta(RutConsts.l8p3,false,false,"UI/SnPPerkRuta.png");
		rutor[112] = new Ruta(RutConsts.l8p4,false,false,"UI/SnPPerkRuta.png");
		rutor[113] = new Ruta(RutConsts.l8p5,false,false,"UI/SnPPerkRuta.png");
		
		rutor[114] = new Ruta(RutConsts.l12,false,false,"UI/SnPPerkRuta.png");
		rutor[115] = new Ruta(RutConsts.l12p1,false,false,"UI/SnPPerkRuta.png");
		rutor[116] = new Ruta(RutConsts.l12p2,false,false,"UI/SnPPerkRuta.png");
		rutor[117] = new Ruta(RutConsts.l12p3,false,false,"UI/SnPPerkRuta.png");
		rutor[118] = new Ruta(RutConsts.l12p4,false,false,"UI/SnPPerkRuta.png");
		rutor[119] = new Ruta(RutConsts.l12p5,false,false,"UI/SnPPerkRuta.png");
		
		rutor[120] = new Ruta(RutConsts.l16,false,false,"UI/SnPPerkRuta.png");
		rutor[121] = new Ruta(RutConsts.l16p1,false,false,"UI/SnPPerkRuta.png");
		rutor[122] = new Ruta(RutConsts.l16p2,false,false,"UI/SnPPerkRuta.png");
		rutor[123] = new Ruta(RutConsts.l16p3,false,false,"UI/SnPPerkRuta.png");
		rutor[124] = new Ruta(RutConsts.l16p4,false,false,"UI/SnPPerkRuta.png");
		rutor[125] = new Ruta(RutConsts.l16p5,false,false,"UI/SnPPerkRuta.png");
		
		rutor[126] = new Ruta(RutConsts.l20,false,false,"UI/SnPPerkRuta.png");
		rutor[127] = new Ruta(RutConsts.l20p1,false,false,"UI/SnPPerkRuta.png");
		rutor[128] = new Ruta(RutConsts.l20p2,false,false,"UI/SnPPerkRuta.png");
		rutor[129] = new Ruta(RutConsts.l20p3,false,false,"UI/SnPPerkRuta.png");
		rutor[130] = new Ruta(RutConsts.l20p4,false,false,"UI/SnPPerkRuta.png");
		rutor[131] = new Ruta(RutConsts.l20p5,false,false,"UI/SnPPerkRuta.png");
		
		rutor[132] = new Ruta(RutConsts.Athlete,false,false,"UI/SnPStatsRuta.png");
		rutor[133] = new Ruta(RutConsts.Ranged,false,false,"UI/SnPStatsRuta.png");
		rutor[134] = new Ruta(RutConsts.Melee,false,false,"UI/SnPStatsRuta.png");
		rutor[135] = new Ruta(RutConsts.Strength,false,false,"UI/SnPStatsRuta.png");
		rutor[136] = new Ruta(RutConsts.Technology,false,false,"UI/SnPStatsRuta.png");
		rutor[137] = new Ruta(RutConsts.Charm,false,false,"UI/SnPStatsRuta.png");
		rutor[138] = new Ruta(RutConsts.FirstAid,false,false,"UI/SnPStatsRuta.png");
		rutor[139] = new Ruta(RutConsts.Surgery,false,false,"UI/SnPStatsRuta.png");
		
		rutor[140] = new Ruta(RutConsts.BoARubrik,false,false,"UI/BoARubrik.png");
		rutor[141] = new Ruta(RutConsts.BoAMelee,false,false,"UI/BoARuta.png");
		rutor[142] = new Ruta(RutConsts.BoARanged,false,false,"UI/BoARuta.png");
		rutor[143] = new Ruta(RutConsts.BoACharm,false,false,"UI/BoARuta.png");
		rutor[144] = new Ruta(RutConsts.BoATech,false,false,"UI/BoARuta.png");
		rutor[145] = new Ruta(RutConsts.BoAHealing,false,false,"UI/BoARuta.png");
		rutor[146] = new Ruta(RutConsts.BoABigBox,false,false,"UI/BoAStorRuta.png");
		
		rutor[147] = new Ruta(RutConsts.QuestLogRubrik,false,false,"UI/QuestLogRubrik.png");
		rutor[148] = new Ruta(RutConsts.QuestLogQuest,false,false,"UI/BoAStorRuta.png");
		rutor[149] = new Ruta(RutConsts.QuestLogQRubrik,false,false,"UI/BoARuta.png");
		rutor[150] = new Ruta(RutConsts.QuestLogProgress,false,false,"UI/BoARuta.png");
		rutor[151] = new Ruta(RutConsts.QuestLogDescription,false,false,"UI/BoARuta.png");
		rutor[152] = new Ruta(RutConsts.QuestLogReward,false,false,"UI/BoARuta.png");//senast
    ...
    private void ruta60(){
    	if(rutaPressed(rutor[60])&&Stats.PPoints>0)
    	{
    		Stats.PPoints--;
    	}
    	else if(rutaPressed(rutor[60])&&!(Stats.PPoints>0))
    	{
    	}
    }
    private void ruta61(){
    	if(rutaPressed(rutor[61])&&Stats.PPoints>0)
    	{
    		Stats.PPoints--;
    	}
    	else if(rutaPressed(rutor[61])&&!(Stats.PPoints>0))
    	{
    	}
    }
    private void ruta62(){
    	if(rutaPressed(rutor[62])&&Stats.PPoints>0)
    	{
    		Stats.PPoints--;
    	}
    	else if(rutaPressed(rutor[62])&&!(Stats.PPoints>0))
    	{
    	}
    }
    private void ruta63(){
    	if(rutaPressed(rutor[63])&&Stats.PPoints>0)
    	{
    		Stats.PPoints--;
    	}
    	else if(rutaPressed(rutor[63])&&!(Stats.PPoints>0))
    	{
    	}
    }
    private void ruta64(){
    	if(rutaPressed(rutor[64])&&Stats.PPoints>0)
    	{
    		Stats.PPoints--;
    	}
    	else if(rutaPressed(rutor[64])&&!(Stats.PPoints>0))
    	{
    	}
    }
    private void ruta65(){
    	if(rutaPressed(rutor[65])&&Stats.PPoints>0)
    	{
    		Stats.PPoints--;
    	}
    	else if(rutaPressed(rutor[65])&&!(Stats.PPoints>0))
    	{
    	}
    }
    private void ruta66(){
    	if(rutaPressed(rutor[66])&&Stats.PPoints>0)
    	{
    		Stats.PPoints--;
    	}
    	else if(rutaPressed(rutor[66])&&!(Stats.PPoints>0))
    	{
    	}
    }
    private void ruta67(){
    	if(rutaPressed(rutor[67])&&Stats.PPoints>0)
    	{
    		Stats.PPoints--;
    	}
    	else if(rutaPressed(rutor[67])&&!(Stats.PPoints>0))
    	{
    	}
    }
    private void ruta68(){
    	if(rutaPressed(rutor[68])&&Stats.PPoints>0)
    	{
    		Stats.PPoints--;
    	}
    	else if(rutaPressed(rutor[68])&&!(Stats.PPoints>0))
    	{
    	}
    }
    private void ruta69(){
    	if(rutaPressed(rutor[69])&&Stats.PPoints>0)
    	{
    		Stats.PPoints--;
    	}
    	else if(rutaPressed(rutor[69])&&!(Stats.PPoints>0))
    	{
    	}
    }
    private void ruta70(){
    	if(rutaPressed(rutor[70])&&Stats.PPoints>0)
    	{
    		Stats.PPoints--;
    	}
    	else if(rutaPressed(rutor[70])&&!(Stats.PPoints>0))
    	{
    	}
    }
    private void ruta71(){
    	if(rutaPressed(rutor[71])&&Stats.PPoints>0)
    	{
    		Stats.PPoints--;
    	}
    	else if(rutaPressed(rutor[71])&&!(Stats.PPoints>0))
    	{
    	}
    }
    private void ruta72(){
    	if(rutaPressed(rutor[72])&&Stats.PPoints>0)
    	{
    		Stats.PPoints--;
    	}
    	else if(rutaPressed(rutor[72])&&!(Stats.PPoints>0))
    	{
    	}
    }
    private void ruta73(){
    	if(rutaPressed(rutor[73])&&Stats.PPoints>0)
    	{
    		Stats.PPoints--;
    	}
    	else if(rutaPressed(rutor[73])&&!(Stats.PPoints>0))
    	{
    	}
    }
    private void ruta74(){
    	if(rutaPressed(rutor[74])&&Stats.PPoints>0)
    	{
    		Stats.PPoints--;
    	}
    	else if(rutaPressed(rutor[74])&&!(Stats.PPoints>0))
    	{
    	}
    }
    private void ruta75(){
    	if(rutaPressed(rutor[75])&&Stats.PPoints>0)
    	{
    		Stats.PPoints--;
    	}
    	else if(rutaPressed(rutor[75])&&!(Stats.PPoints>0))
    	{
    	}
    }
    private void ruta76(){
    	if(rutaPressed(rutor[76])&&Stats.PPoints>0)
    	{
    		Stats.PPoints--;
    	}
    	else if(rutaPressed(rutor[76])&&!(Stats.PPoints>0))
    	{
    	}
    }
    private void ruta77(){
    	if(rutaPressed(rutor[77])&&Stats.PPoints>0)
    	{
    		Stats.PPoints--;
    	}
    	else if(rutaPressed(rutor[77])&&!(Stats.PPoints>0))
    	{
    	}
    }
    private void ruta78(){
    	if(rutaPressed(rutor[78])&&Stats.PPoints>0)
    	{
    		Stats.PPoints--;
    	}
    	else if(rutaPressed(rutor[78])&&!(Stats.PPoints>0))
    	{
    	}
    }
    private void ruta79(){
    	if(rutaPressed(rutor[79])&&Stats.PPoints>0)
    	{
    		Stats.PPoints--;
    	}
    	else if(rutaPressed(rutor[79])&&!(Stats.PPoints>0))
    	{
    	}
    }
    private void ruta80(){
    	if(rutaPressed(rutor[80])&&Stats.PPoints>0)
    	{
    		Stats.PPoints--;
    	}
    	else if(rutaPressed(rutor[80])&&!(Stats.PPoints>0))
    	{
    	}
    }
    private void ruta81(){
    	if(rutaPressed(rutor[81])&&Stats.PPoints>0)
    	{
    		Stats.PPoints--;
    	}
    	else if(rutaPressed(rutor[81])&&!(Stats.PPoints>0))
    	{
    	}
    }
    private void ruta82(){
    	if(rutaPressed(rutor[82])&&Stats.PPoints>0)
    	{
    		Stats.PPoints--;
    	}
    	else if(rutaPressed(rutor[82])&&!(Stats.PPoints>0))
    	{
    	}
    }
    private void ruta83(){
    	if(rutaPressed(rutor[83])&&Stats.PPoints>0)
    	{
    		Stats.PPoints--;
    	}
    	else if(rutaPressed(rutor[83])&&!(Stats.PPoints>0))
    	{
    	}
    }
    private void ruta84(){
    	if(rutaPressed(rutor[84])&&Stats.PPoints>0)
    	{
    		Stats.PPoints--;
    	}
    	else if(rutaPressed(rutor[84])&&!(Stats.PPoints>0))
    	{
    	}
    }
    private void ruta85(){
    	if(rutaPressed(rutor[85])&&Stats.PPoints>0)
    	{
    		Stats.PPoints--;
    	}
    	else if(rutaPressed(rutor[85])&&!(Stats.PPoints>0))
    	{
    	}
    }
    private void ruta86(){
    	if(rutaPressed(rutor[86])&&Stats.PPoints>0)
    	{
    		Stats.PPoints--;
    	}
    	else if(rutaPressed(rutor[86])&&!(Stats.PPoints>0))
    	{
    	}
    }
    private void ruta87(){
    	if(rutaPressed(rutor[87])&&Stats.PPoints>0)
    	{
    		Stats.PPoints--;
    	}
    	else if(rutaPressed(rutor[87])&&!(Stats.PPoints>0))
    	{
    	}
    }
    private void ruta88(){
    	if(rutaPressed(rutor[88])&&Stats.PPoints>0)
    	{
    		Stats.PPoints--;
    	}
    	else if(rutaPressed(rutor[88])&&!(Stats.PPoints>0))
    	{
    	}
    }
    private void ruta89(){
    	if(rutaPressed(rutor[89])&&Stats.PPoints>0)
    	{
    		Stats.PPoints--;
    	}
    	else if(rutaPressed(rutor[89])&&!(Stats.PPoints>0))
    	{
    	}
    }
    ...
    {
    	if(rutaPressed(rutor[132])&&Stats.SPoints>0){
    		Skills.Athletics++;
    		Stats.SPoints--;
    	}
    	else if(rutaPressed(rutor[132])&&!(Stats.SPoints>0)){
    		
    	} 
    }
    private void ruta133()
    {
    	if(rutaPressed(rutor[133])&&Stats.SPoints>0){
    		Skills.Ranged++;
    		Stats.SPoints--;
    	}
    	else if(rutaPressed(rutor[133])&&!(Stats.SPoints>0)){
    		
    	} 
    }
    private void ruta134()
    {
    	if(rutaPressed(rutor[134])&&Stats.SPoints>0){
    		Skills.Melee++;
    		Stats.SPoints--;
    	}
    	else if(rutaPressed(rutor[134])&&!(Stats.SPoints>0)){
    		
    	} 
    }
    private void ruta135()
    {
    	if(rutaPressed(rutor[135])&&Stats.SPoints>0){
    		Skills.Strength++;
    		Stats.SPoints--;
    	}
    	else if(rutaPressed(rutor[135])&&!(Stats.SPoints>0)){
    		
    	} 
    }
    private void ruta136()
    {
    	if(rutaPressed(rutor[136])&&Stats.SPoints>0){
    		Skills.Technology++;
    	}
    	else if(rutaPressed(rutor[136])&&!(Stats.SPoints>0)){
    		
    	} 
    }
    private void ruta137()
    {
    	if(rutaPressed(rutor[137])&&Stats.SPoints>0){
    		Skills.Charm++;
    		Stats.SPoints--;
    	}
    	else if(rutaPressed(rutor[137])&&!(Stats.SPoints>0)){
    		
    	} 
    }
    private void ruta138()
    {
    	if(rutaPressed(rutor[138])&&Stats.SPoints>0){
    		Skills.FirstAid++;
    		Stats.SPoints--;
    	}
    	else if(rutaPressed(rutor[138])&&!(Stats.SPoints>0)){
    		
    	} 
    }
    private void ruta139()
    {
    	if(rutaPressed(rutor[139])&&Stats.SPoints>0){
    		Skills.Surgery++;
    		Stats.SPoints--;
    	}
    	else if(rutaPressed(rutor[139])&&!(Stats.SPoints>0)){
